...
git_url = "https://git.assembla.com/Plasma-Portfolio/c2m-ci.C2M.git"  # Git URL of the repository
username = "rohan_n"  # Your Assembla username
token = "7765605f85d06a987cd42ac5786bf80f8f031607"  # Your personal access token
...
try:
    ...
    # Count all branches (local and remote)
    total_branches = len([branch for branch in branches if branch.strip()])  # Count non-empty branches

    print(f"Total number of branches (including main, master, and feature branches) in the repository: {total_branches}")
